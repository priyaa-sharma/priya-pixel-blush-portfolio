  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <button onClick={() => scrollToSection('about')} className="text-gray-600 hover:text-pink-600 transition-colors">About</button>
              <button onClick={() => scrollToSection('projects')} className="text-gray-600 hover:text-pink-600 transition-colors">Projects</button>
              <button onClick={() => scrollToSection('skills')} className="text-gray-600 hover:text-pink-600 transition-colors">Skills</button>
              <button onClick={() => scrollToSection('contact')} className="text-gray-600 hover:text-pink-600 transition-colors">Contact</button>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              ...
              variant="outline"
              className="border-pink-300 text-pink-600 hover:bg-pink-50 px-8 py-3 rounded-full text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <Badge className="bg-pink-100 text-pink-700 hover:bg-pink-200">🎨 UI/UX Design</Badge>
                  <Badge className="bg-pink-100 text-pink-700 hover:bg-pink-200">💻 Clean Code</Badge>
                  <Badge className="bg-pink-100 text-pink-700 hover:bg-pink-200">🌸 Aesthetic Details</Badge>
                  <Badge className="bg-pink-100 text-pink-700 hover:bg-pink-200">✨ User Experience</Badge>
                </div>
              </div>
            </div>
            
            <div className="relative">
              <div className="w-80 h-80 bg-gradient-to-br from-pink-200 to-pink-300 rounded-full mx-auto shadow-2xl">
      ...
      <section id="projects" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-pink-400 mx-auto rounded-full"></div>
            <p className="text-lg text-gray-600 mt-6">Here are some of my favorite creations</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-300 hover:scale-105 border-pink-100 bg-white/80 backdrop-blur-sm">
                <div className="aspect-video bg-gradient-to-br from-pink-100 to-pink-200 rounded-t-lg flex items-center justify-center">
                  ...
                  <span className="ml-2 text-gray-600">Image placeholder</span>
                </div>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech, techIndex) => (
                      <Badge key={techIndex} variant="secondary" className="bg-pink-50 text-pink-700">
                        {tech}
                      </Badge>
                    ))}
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-pink-100 bg-white/80 backdrop-blur-sm hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-4">🖥️ Front-End Development</h3>
                <div className="flex flex-wrap gap-2 justify-center">
                  {techStack.frontend.map((skill, index) => (
                    <Badge key={index} className="bg-pink-50 text-pink-700">
                      {skill}
                    </Badge>
                  ))}
                </div>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Let's Create Something Beautiful Together 💌</h2>
            <div className="w-20 h-1 bg-pink-400 mx-auto rounded-full"></div>
            <p className="text-lg text-gray-600 mt-6">Have a project in mind? I'd love to hear from you!</p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">linkedin.com/in/priyasharma</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">github.com/priyasharma</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <CardContent className="p-6">
                <form className="space-y-4">
                  <div>
                    ...
                    <Input className="border-pink-200 focus:border-pink-400" placeholder="Your name" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
                    <Input type="email" className="border-pink-200 focus:border-pink-400" placeholder="your.email@example.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Message</label>
                    <Textarea className="border-pink-200 focus:border-pink-400 min-h-32" placeholder="Tell me about your project..." />
                  </div>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 bg-pink-50">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Priya Sharma</h3>
            <p className="text-gray-600 italic">Crafting web dreams with code & charm.</p>
          </div>
          
          <div className="flex justify-center space-x-6 mb-8">
            <a href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
              <Mail className="w-6 h-6 text-pink-600" />
            </a>
            <a href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
              <Linkedin className="w-6 h-6 text-pink-600" />
          ...
          <div className="border-t border-pink-200 pt-8">
            <p className="text-gray-500">© 2024 Priya Sharma. Made with 💕 and lots of code.</p>
          </div>
        </div>
      </footer>
    </div>
